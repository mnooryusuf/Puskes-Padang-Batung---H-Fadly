...
<html>
<head>
    <title>Laporan Statistik Laboratorium</title>
    <style>
...
<body>
    <div class="header">
        <h2>Laporan Statistik Pemeriksaan Laboratorium</h2>
    ...
    <table>
        <thead>
            <tr>
                <th>No</th>
                <th>Jenis Pemeriksaan / Instruksi</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $index + 1 }}</td>
                <td class="text-left">{{ $item->instruksi_lab }}</td>
                <td>{{ $item->total }} Kali</td>
            </tr>
            @endforeach
            @if($data->isEmpty())
            <tr>
                <td colspan="3">Tidak ada data pemeriksaan lab pada periode ini.</td>
            </tr>
            @endif
        </tbody>
    </table>
